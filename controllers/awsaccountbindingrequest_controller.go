...
// the AWSAccountBindingRequest object against the actual cluster state, and then
...
func (r *AWSAccountBindingRequestReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("awsaccountbindingrequest", req.NamespacedName)
...
func (r *AWSAccountBindingRequestReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&integrationsv1alpha1.AWSAccountBindingRequest{}).
		Complete(r)
}
