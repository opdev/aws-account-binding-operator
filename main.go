...
import (
	...
	"github.com/opdev/aws-account-binding-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "381a54b3.opdev.io",
	})
	if err != nil {
	...
	if err = (&controllers.AWSAccountBindingRequestReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("AWSAccountBindingRequest"),
	...
	if err = (&controllers.AWSAccountBindingApprovalReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("AWSAccountBindingApproval"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AWSAccountBindingApproval")
		os.Exit(1)
	}
